...
- Keep validated workbench definitions and edit staging in the pure Workbench project. Keep rendering and editor controls in the Godot adapter.
...
```text
src/          Pure .NET simulation and workbench model projects
